...
export default function TeacherDashboard() {
  ...
  const handleCreateClass = async (e: React.FormEvent) => {
    ...
    const { data: existingCode } = await supabase
      .from('used_verification_codes')
      .select('id')
      .eq('code', formData.verification_code)
      .maybeSingle();

    if (existingCode) {
      toast.error('This verification code has already been used. Each code can only be used once.');
      return;
    }
